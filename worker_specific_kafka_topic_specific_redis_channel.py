...
def worker():
    ...
    consumer = KafkaConsumer(
        'your_topic',  # Replace 'your_topic' with the actual topic name
    ...
    for message in consumer:
        ...
        # Publish message to Redis channel after the task is successfully completed
        redis_client.publish('your_channel', 'Task done successfully')
